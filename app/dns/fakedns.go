...
func (s *FakeDNSClient) LookupIP(domain dns.MatsuriDomainString) ([]net.IP, error) {
	return s.lookupIPInternal(domain, dns.IPOption{IPv4Enable: true, IPv6Enable: true, FakeEnable: true})
}

// LookupIPv4 implements dns.IPv4Lookup.
func (s *FakeDNSClient) LookupIPv4(domain dns.MatsuriDomainString) ([]net.IP, error) {
	return s.lookupIPInternal(domain, dns.IPOption{IPv4Enable: true, FakeEnable: true})
}

// LookupIPv6 implements dns.IPv6Lookup.
func (s *FakeDNSClient) LookupIPv6(domain dns.MatsuriDomainString) ([]net.IP, error) {
...
func (f *FakeDNSEngine) GetFakeIPForDomain3(domain string, IPv4 bool, IPv6 bool) []net.Address { // nolint: gocritic
	...
	for _, client := range f.dns.sortClients(domain, nil, option) {
